...
1.  Look at the plot that you created. What do you notice about the order of the bars / order of the legend?
    ...
    **the bars are not arranged in the order of the sanitation ladder**

2.  What would you want to change?

    **colour of the bars and arranging the bars in order of a sanitation ladder**

3.  Why did we remove "safely managed sanitation services" from the data set in Task 3?

    **sanitation interventions are crucial from no sanitation facilities to basic sanitation services to help residences climb up the sanitation ladde**r
